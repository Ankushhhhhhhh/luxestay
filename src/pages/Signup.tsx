...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      // Wait a bit and navigate to login
      ...
      >
        ...
        {success && (
          <div className="bg-emerald-50 text-emerald-600 p-3 rounded-lg text-sm mb-4">
            Signup successful! Please check your email for a confirmation link. Redirecting to login...
          </div>
        )}
        ...
        <div className="mt-6 text-center text-sm text-neutral-500">
          ...
          <Link to="/login" className="text-[#FF385C] font-bold hover:underline">
            Log in
          </Link>
        </div>
      </motion.div>
